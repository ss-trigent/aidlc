...
1. **Direction.** GitHub is the source of truth and flows outward to Jira. A Jira ticket may additionally serve as _intake_ — saved verbatim into `inception/product/inputs/` and treated like any other raw customer need. Approval flows in neither direction.
