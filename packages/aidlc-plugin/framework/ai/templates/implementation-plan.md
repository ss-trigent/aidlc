...
> **The Gate D1 artifact.** The human reads this file and `impact-analysis.md`, then approves in chat. DEV stamps the approval below and commits it. No code is written before that stamp exists.
